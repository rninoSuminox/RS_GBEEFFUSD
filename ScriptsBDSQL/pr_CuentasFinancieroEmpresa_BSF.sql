	...
	if exists(select 1 from sys.tables where name='TEMPSALDOSF')
		...
		CREATE TABLE TEMPSALDOSF (ANIO			INT
								 ,PERIODID			INT
									...
									,USDDBTM		NUMERIC(19,5)
									,USDCRDM		NUMERIC(19,5)
									,NOTA			CHAR(20)
									,PSTNGTYP		smallint)
...
--se agrega cuenta 115.07 - RN 10062022-SOLICITUD DE ROBERTO
	...
	WHILE @@FETCH_STATUS = 0  
		...
		INSERT INTO TEMPSALDOSF (ANIO,PERIODID,MES,TRXDATE,DEBITAMT,CRDTAMNT,ORDBTAMT,ORCRDAMT,ACTDESCR,ACTNUMST,CURNCYID,PSTNGTYP,NOTA)
									SELECT   HSTYEAR ANIO									      
											,PERIODID,PERIODID MES
											,S.TRXDATE TRXDATE
											,SUM(S.DEBITAMT) DEBITAMT
											,SUM(S.CRDTAMNT) CRDTAMNT
											,SUM(ISNULL(B.ORDBTAMT,IIF(RTRIM(CURNCYID)=''USD'',S.ORDBTAMT,0))) ORDBTAMT
											,SUM(ISNULL(B.ORCRDAMT,IIF(RTRIM(CURNCYID)=''USD'',S.ORCRDAMT,0))) ORCRDAMT
											...
											,MAX(IIF(B.ORCRDAMT IS NULL,0,1)) NOTA
...
C1: se cambia para colocar los USD manuales
